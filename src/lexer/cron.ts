...
// Base tokens
export const cronTokens = [whiteSpace, identifier, months, days, dash, slash, comma, integer, every];

export const cronVocabulary: TokenVocabulary = genVocabulary(cronTokens);
